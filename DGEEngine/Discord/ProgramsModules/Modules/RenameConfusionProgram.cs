...
namespace DGE.ProgramModules
{
    public class RenameConfusionProgram : ProgramModule
    {
        ...
        public RenameConfusionProgram(ProgramData programData, IBot bot) : base(programData, bot) { }
        ...
        public static string NextCode()
        {
            ...
            AssemblyEngine.logger.Log($"New code : {res}", EnderEngine.Logger.LogLevel.INFO, EnderEngine.Logger.LogMethod.TO_CONSOLE);
            return res;
        }
